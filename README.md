...
Este repositório faz parte de uma revisão que fiz sobre a conexão ao postgres usando o java, mas sem nenhum framework, estou postando o mesmo no github para
